...
class Movie extends VideoTape{
    ...
    public void Show()
    {
        System.out.println("Title: "+title+" Length: "+length+" Availablity: "+Available+" DirectorRanking: "+DirectorRanking);
    }
}
class MusicVideo extends VideoTape{
    ...
    public void Show()
    {
        System.out.println("Title: "+title+" Length: "+length+" Availablity: "+Available+" ArtistCategory: "+ArtistCategory);
    }
}
